...
def draw_chart(coin,duration):
        ...
        #Draws and saves as chart.png in the static folder a chart of the selected coin and the specific duration. It uses Coingecko APIs and available durations are (in days): 1, 7, 14, 30, 90, 180, 365 and "max"
